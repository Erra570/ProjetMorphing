...
public class MorphingImgVisage {
     ...
     * @param f fichier de l'image de fin
     * @param nombreImg nombre d'images dans l'animation
     * @throws Exception 
     */
    public void creerGif(List<Triangle> tabD, List<Triangle> tabF, Fichier f, double nombreImg) throws Exception {
        ...
        for(int i = 1; i <= nombreImg; i++) {
            ...
            this.imgSuivanteVisage(tabSuivant, tabF, ImageIO.read(f.getF()), (1/nombreImg) * i);  // Mise à jour de l'image avec les nouveaux points                
